# Documentação do VitoriaFinance

Esta pasta separa o funcionamento atual do sistema das ideias planejadas para as próximas versões.
...
Para usar ou avaliar o sistema, comece pelo guia funcional. Para desenvolver ou instalar, leia também os documentos de instalação e arquitetura.
